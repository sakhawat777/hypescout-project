	...
	return (
		<div>
			<div
				className={
					shadowMe
						? ' w-full h-20 shadow-lg shadow-gray-900 bg-primaryColor text-black border-b-[1px] border-t-orange-700 z-[100]'
				...
				<div className='m-2 md:m-6 md:mx-36 h-full'>
					...
					<div
						className={
							sideBar
								? 'md:hidden absolute left-0 top-[5rem] w-full h-screen bg-slate-700   ease-in duration-300 z-40 fcc'
